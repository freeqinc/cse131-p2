			  ...
			  switch (nState)
        {
          ...
          case S_HEX:
            ...
            else
            {
				...
				token = new Token (sym.T_INT_LITERAL, Integer.parseInt(bufferString.substring(2), 16) + "");
            }
            break;
          ...
          case S_OCTAL:
            ...
            else
            {
				ungetChar (c);
				bufferString = new String(buffer);
				token = new Token (sym.T_INT_LITERAL, Integer.parseInt(bufferString.substring(1), 8) + "");
            }
            break;
